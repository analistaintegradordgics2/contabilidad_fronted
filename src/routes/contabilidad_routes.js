...
const routes = [
  // Ruta para el plan unico de cuentas
  {
    ...
    name: 'plandecuentas',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/plancuentas/index.vue'),
    meta: {
      breadcrumbs: [
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/plancuentas/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
  ...
  // Ruta para los conceptos
  {
    ...
    name: 'conceptos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/conceptos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'crearconceptos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/conceptos/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  // Ruta para los tipo de documentos
  {
    ...
    name: 'tipodocumentos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/tipodocumentos/index.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/tipodocumentos/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  // Ruta para los centros de costos
  {
    ...
    name: 'centroscostos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/centro_costos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/centro_costos/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Captura de datos', to: { name: '' } },
  ...
  // Ruta para los bancos
  {
    ...
    name: 'bancos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/bancos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'crearbancos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/bancos/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Captura de datos', to: { name: '' } },
  ...
  // Ruta para las cuentas bancarias
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/cuentas_bancarias/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Captura de datos', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/captura_datos/cuentas_bancarias/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Captura de datos', to: { name: '' } },
  ...
  // Ruta para los documentos
  {
    ...
    name: 'documentos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/documentos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/documentos/partial/crear.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Gestión Contable', to: { name: 'home' } },
  ...
  // Ruta para informe diario de caja
  {
    ...
    name: 'infdiariocaja',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/infdiariocaja/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/conta_planos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Procesos', to: { name: '' } },
  ...
  // Ruta para informe diario de caja
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/conciliacion_bancaria/index.vue'),
    meta: {
      breadcrumbs: [
  ...
  // Ruta para consultas
  {
    ...
    name: 'auxcodigonit',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/auxiliarcodigonit/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
  ...
  },
  {
    ...
    name: 'auxbancos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/auxiliarbancos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'balancegeneral',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/balancegeneral/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'balanceprueba',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/balanceprueba/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/estadoresultados/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/comprobantediario/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/infcomparativos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'auxauditoria',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/auditoria/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        // { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'infcartera',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/informecartera/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Consultas', to: { name: '' } },
  ...
  },
  {
    ...
    name: 'infcarteradian',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/informediariodian/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Consultas', to: { name: '' } },
  ...
  // Ruta para certificados de propietario y arrendatarios
  {
    ...
    name: 'certificados',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/consultas/certificados/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Consultas', to: { name: '' } },
  ...
  // Ruta para cierres
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/cierres/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Procesos', to: { name: '' } },
  ...
  // Ruta para cierres
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/reconstruccion/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Gestión Contable', to: { name: 'home' } },
        { label: 'Procesos', to: { name: '' } },
  ...
  // Ruta para cierres
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/cambio_fechas/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Contabilidad', to: { name: 'home' } },
        { label: 'Procesos', to: { name: '' } },
  ...
  // Ruta para cargos fijos
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/cargos_fijos/index.vue'),
    meta: {
      breadcrumbs: [
        // { label: 'Contabilidad', to: { name: 'home' } },
        { label: 'Procesos', to: { name: '' } },
  ...
  // Ruta para Exogena
  {
    ...
    name: 'exogena',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/exogena/index.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Contabilidad', to: { name: 'home' } },
  ...
  // Ruta para cargos masivos
  {
    ...
    name: 'cargos_masivos',
    component: () => import('contabilidad_frontend/src/pages/contabilidad/cargos_masivos/index.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Contabilidad', to: { name: 'home' } },
  ...
  // Ruta para medios distritales
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/medios_distritales/index.vue'),
    meta: {
      breadcrumbs: [
        { label: 'Contabilidad', to: { name: 'home' } },
  ...
  // Cierres especiales
  {
    ...
    component: () => import('contabilidad_frontend/src/pages/contabilidad/procesos/cierre_especial/index.vue'),
    meta: {
      breadcrumbs: [
        {label: 'Contabilidad',to: {name: 'home'}},
        {label: 'Procesos', to: {name: ''}},
